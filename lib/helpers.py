...
def find_department_by_id(): # uses trailing underscore not to override the built-in id function
...
def find_employee_by_name() -> None:
...
def create_employee():
    name = input("Enter the employee's name: ")
    job_title = input("Enter the employee's department: ")
...
#     department_id = input("What is the department id of the department you'd like the list of employees from? ")
